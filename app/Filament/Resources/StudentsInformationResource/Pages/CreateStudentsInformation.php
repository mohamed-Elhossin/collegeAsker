...
class CreateStudentsInformation extends CreateRecord
{
        ...
        return [
                ...
                Step::make('البيانات شخصية')
                    ->schema([
                        ...
                        TextInput::make('military_number')->label('الرقم العسكري')->required()->numeric(),
                        TextInput::make('batch')->label('الدفعة')->required()->numeric(),
                        TextInput::make('medical_fitness')->label('اللياقة الطبية')->required()->numeric(),
                    ...
                    ->schema([
                        ...
                        TextInput::make('number_of_family_members')->label('عدد افراد الاسرة')->required()->numeric(),
                        TextInput::make('number_of_brothers')->label('عدد الاخوة و الترتيب بينهم')->required(),
                        TextInput::make('males')->label('ذكور')->required()->numeric(),
                        TextInput::make('females')->label('اناث')->required()->numeric(),
                        ...
                        ->inline()
                        ->required(),
                        DatePicker::make('date_of_separation')->label('تاريخ الانفصال'),
                    ...
                    ->schema([
                        ...
                        TextInput::make('the_entity_from_which_he_obtained_a_qualification')->label('المدرسة او الجهة التي حصل منها علي الشهادة')->required(),
                        TextInput::make('percentage_in_high_school')->label('النسبة المؤية في الثانوية العامة')->required()->numeric(),
                        ...
                        ->inline()
                        ->required(),
                        TextInput::make('degree_he_earned')->label('الدرجة الحاصل عليها')->required()->numeric(),
